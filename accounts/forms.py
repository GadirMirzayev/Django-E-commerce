...
class PasswordChangeForm(forms.Form):
    ...
    new_password1 = forms.CharField(max_length=40, widget=forms.PasswordInput(attrs={
        'placeholder': 'New Password'
    }))
    new_password2 = forms.CharField(max_length=40, widget=forms.PasswordInput(attrs={
